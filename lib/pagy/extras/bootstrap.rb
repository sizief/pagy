...
class Pagy
  module Frontend
    ...
    Pagy.deprecate self, :pagy_nav_bootstrap, :pagy_boostrap_nav

    # Compact pagination for bootstrap: it returns the html with the series of links to the pages
    # we use a numeric input tag to set the page and the Pagy.compact javascript to navigate
    def pagy_boostrap_compact_nav(pagy, id=caller(1,1)[0].hash)
    ...
    Pagy.deprecate self, :pagy_nav_compact_bootstrap, :pagy_boostrap_compact_nav
